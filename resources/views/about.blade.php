...
@section('styles')
    ...
    <style>
        .about-image-shadow {
            box-shadow: 20px 20px 0px 0px #c8a98d; /* Shadow màu vàng gold đổ khối */
        }
        .play-btn-pulse {
...
@section('content')
    <section class="relative h-[55vh] flex items-center justify-center overflow-hidden">
        <div class="absolute inset-0 w-full h-full">
            <img src="https://images.unsplash.com/photo-1519741497674-611481863552" alt="Hero About" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 text-center text-white px-6" data-aos="fade-up">
            ...
            <h1 class="text-5xl md:text-6xl font-serif font-bold mb-4 italic">Hành Trình Nghệ Thuật</h1>
            <p class="text-lg font-light opacity-80 tracking-widest">Tôn vinh vẻ đẹp nguyên bản</p>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
            <div class="w-full md:w-5/12" data-aos="fade-right">
                <div class="relative about-image-shadow rounded-2xl overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1595959183082-7b570b7e08e2" alt="Luyện Thị Thảo" class="w-full aspect-[4/5] object-cover">
                </div>
            </div>
            <div class="w-full md:w-7/12" data-aos="fade-left">
                ...
                <h2 class="text-4xl md:text-5xl font-serif text-dark mb-8 leading-tight">Xin chào, tôi là <br><span class="italic">Luyện Thị Thảo</span></h2>
                <div class="space-y-6 text-gray-700 leading-relaxed font-light text-lg">
                    <p>Hành trình đến với nghệ thuật trang điểm của tôi bắt nguồn từ niềm đam mê mãnh liệt với cái đẹp và khát khao đánh thức sự tự tin trong mỗi người phụ nữ.</p>
                    <p>Hoạt động chuyên nghiệp tại Hà Nội và Hưng Yên, tôi theo đuổi phong cách <strong>Nude Luxury</strong> – tinh giản, sang trọng nhưng đầy chiều sâu. Đối với tôi, trang điểm không phải là phủ lên một lớp mặt nạ rập khuôn, mà là quá trình tôn vinh nét đẹp riêng biệt của chính bạn.</p>
                </div>
                <img src="https://images.unsplash.com/photo-1596462502278-27bfdc403348" alt="Chữ ký" class="w-32 mt-10 opacity-60 mix-blend-multiply">
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-white px-6">
        <div class="max-w-4xl mx-auto text-center" data-aos="zoom-in">
            ...
            <div class="relative rounded-3xl overflow-hidden group shadow-2xl aspect-video cursor-pointer border-8 border-primary">
                <img src="https://images.unsplash.com/photo-1522337660859-02fbefca4702" alt="Video Cover" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                <div class="absolute inset-0 bg-black/30 group-hover:bg-black/40 transition-colors"></div>
                <a href="https://www.youtube.com/watch?v=maSuEtbPJ8Y" class="glightbox absolute inset-0 flex items-center justify-center z-10">
            ...
            <div class="space-y-16 relative before:absolute before:inset-0 before:left-0 md:before:left-1/2 before:w-[1px] before:bg-gold/20">
                <div class="relative flex flex-col md:flex-row items-center" data-aos="fade-up">
                    <div class="md:w-1/2 md:pr-12 md:text-right">
                        <h4 class="text-2xl font-serif text-gold mb-2">2019</h4>
                        <p class="font-light text-gray-600 text-sm">Bắt đầu hành trình với các khóa đào tạo chuyên sâu tại Hà Nội.</p>
                    </div>
                ...
                <div class="relative flex flex-col md:flex-row items-center" data-aos="fade-up">
                    ...
                    <div class="md:w-1/2 md:pl-12">
                        <h4 class="text-2xl font-serif text-gold mb-2">2021</h4>
                        <p class="font-light text-gray-600 text-sm">Định hình phong cách Nude Luxury và phục vụ hàng trăm cô dâu.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="overflow-hidden rounded-2xl shadow-lg group" data-aos="fade-up">
                    <img src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1" class="w-full h-[500px] object-cover group-hover:scale-110 transition-transform duration-700">
                </div>
                <div class="overflow-hidden rounded-2xl shadow-lg group" data-aos="fade-up" data-aos-delay="100">
                    <img src="https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e" class="w-full h-[500px] object-cover group-hover:scale-110 transition-transform duration-700">
                </div>
                <div class="overflow-hidden rounded-2xl shadow-lg group" data-aos="fade-up" data-aos-delay="200">
                    <img src="https://images.unsplash.com/photo-1492707892479-7bc8d5a4ee93" class="w-full h-[500px] object-cover group-hover:scale-110 transition-transform duration-700">
                </div>
            </div>
        </div>
    </section>

    <section id="academy" class="py-32 bg-dark text-white text-center">
        <div class="max-w-3xl mx-auto px-6" data-aos="zoom-in">
            ...
            <p class="text-lg font-light text-white/70 mb-10 leading-relaxed">
                Khơi dậy tiềm năng nghệ thuật trong bạn. Các khóa đào tạo từ makeup cá nhân đến chuyên nghiệp, cam kết truyền lửa và đồng hành cùng đam mê.
            </p>
            <a href="https://zalo.me/{{ $settings['phone'] ?? '' }}" class="inline-block bg-gold text-dark px-10 py-4 rounded-full text-xs uppercase tracking-widest font-bold hover:bg-white transition-all">
                Tìm hiểu khóa học
            </a>
        </div>
    </section>
