...
@section('content')
        ...
        @if($banners->count() > 0)
            @foreach($banners as $banner)
                ...
                <div class="relative z-10 text-center text-white px-6 max-w-4xl" data-aos="fade-up">
                    <span class="block text-sm font-light tracking-[0.3em] uppercase mb-4 text-gold">High-End Experience</span>
    ...
    <section class="py-32 px-6 max-w-4xl mx-auto text-center" data-aos="fade-up">
        <h2 class="text-4xl md:text-5xl font-serif mb-8 text-dark">Nghệ Thuật Của Sự Tinh Tế</h2>
        <p class="text-lg font-light leading-relaxed text-gray-700 italic">
            "Mỗi khuôn mặt là một tác phẩm nghệ thuật riêng biệt. Sứ mệnh của tôi là đánh thức vẻ đẹp rạng rỡ nhất ẩn sâu bên trong bạn."
        </p>
    </section>
    ...
    <section class="py-32 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-20">
                <span class="text-gold text-sm tracking-widest uppercase mb-2 block font-medium">Bảng giá & Dịch vụ</span>
                <h2 class="text-4xl md:text-5xl font-serif text-dark uppercase tracking-tight">Luxury Services</h2>
            </div>
    ...
    <section class="py-32 bg-primary">
        <div class="max-w-5xl mx-auto px-6 text-center">
            <h2 class="text-4xl font-serif mb-12">The Magic Transformation</h2>
            <div class="rounded-3xl overflow-hidden shadow-2xl border-8 border-white">
                <img-comparison-slider>
                    <img slot="first" src="https://images.unsplash.com/photo-1512496015851-a90fb38ba796?q=80&w=2000" />
                    <img slot="second" src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?q=80&w=2000" />
                </img-comparison-slider>
            </div>
        </div>
    </section>
    ...
    <section class="py-32">
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-end mb-16 border-b border-black/5 pb-8">
                <h2 class="text-4xl font-serif italic text-dark">Journal</h2>
            ...
            <div class="grid md:grid-cols-3 gap-12">
                ...
                <a href="{{ route('posts.show', $post->slug) }}" class="group block overflow-hidden" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                    ...
                    <span class="text-[10px] uppercase tracking-widest text-gold mb-2 block font-bold">{{ $post->published_at->format('d/m/Y') }}</span>
